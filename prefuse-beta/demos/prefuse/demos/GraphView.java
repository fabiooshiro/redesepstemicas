...
public class GraphView extends JPanel {
    ...
    public GraphView(Graph g, String label) {
        ...
        er.setArrowType(prefuse.Constants.EDGE_ARROW_FORWARD);
        er.setArrowHeadSize(5,5);
        //er.setEdgeType(prefuse.Constants.EDGE_TYPE_CURVE);
...
//        opanel.add(overview);
    ...
    static void addEdge(Graph g,Node a, String val, Node b){
    	Node v = g.addNode();
    	v.setString(GraphLib.LABEL, val);
    	g.addEdge(a, v);
    	g.addEdge(v, b);
    }
	static Graph getGraph() {
		...
		Node fabio = g.addNode();
		fabio.setString(GraphLib.LABEL, "Fabio");
		Node haroldo = g.addNode();
		...
		addEdge(g, clemilson, "323",haroldo);
		addEdge(g, fabio, "323",clemilson);
		addEdge(g, clemilson, "323",fabio);
		return g;
	}
